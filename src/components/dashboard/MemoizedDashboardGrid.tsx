...
const ProjectCard = memo(
  ({ title, progress, team, dueDate }: ProjectCardProps) => {
    return (
...
const LoadingCard = () => (
  <Card className="bg-white/90 backdrop-blur-sm border border-gray-100 rounded-2xl shadow-sm h-[220px] flex items-center justify-center">
...
const MemoizedDashboardGrid = memo(
  ({ projects = defaultProjects, isLoading = false }: DashboardGridProps) => {
